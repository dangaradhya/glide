        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
          {commentsLoading ? (
            ...
            comments.map(comment => {
              ...
              // Dynamic Profile Logic: Check localStorage for custom profile overrides
              let displayName = comment.name;
              let displayPicture = comment.picture || 'https://via.placeholder.com/40';

              // If the user has set a custom profile in localStorage, we override the default name and picture.
