  ...
  return (
    <main className="max-w-4xl mx-auto p-6 md:p-12 text-gray-800 dark:text-gray-200 mt-10">
      ...
      <div className="space-y-6 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">3. User Conduct and Commenting Rules</h2>
          <p>When participating in the comment sections, you agree not to:</p>
          <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">4. Changes to Terms</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">5. Disclaimer of Warranties</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">6. Governing Law</h2>
